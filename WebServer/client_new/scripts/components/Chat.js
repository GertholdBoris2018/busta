    ...
    return React.createClass({
        ...
        _sendMessage: function(e) {
            if(e.keyCode == 13) {
                ...
                var elem = document.getElementById('currentUserCls');
                var currentUserCls = elem.value;
                ...
                if(ChatEngine.chatstate == 'DECLINED'  && currentUserCls !='admin'){
                    this._doCommand('/unauthorized');
                }
                else{
        ...
        _doCommand: function(msg) {
            ...
            switch(cmd) {
                ...
                case 'ignored':
                    ...
                    return true;
                case 'unauthorized':
                    ChatActions.showClientMessage('Chat is prohibited while waiting for approval from admin.');
