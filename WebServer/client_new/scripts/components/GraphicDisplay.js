...
define([
    ...
    Graph.prototype.drawGameData = function() {
        ...
        if(Engine.gameState === 'ENDED') {
            ...
            this.ctx.fillText('게임종료', this.canvasWidth/2, this.canvasHeight/2 - fontSizeNum(15)/2);
            this.ctx.fillText('x ' + Clib.formatDecimals(Engine.tableHistory[0].game_crash/100, 2) + 'x', this.canvasWidth/2, this.canvasHeight/2 + fontSizeNum(15)/2);
        }
        ...
        if(Engine.gameState === 'STARTING') {
            ...
            this.ctx.fillText('다음게임 시작 '+timeLeft+'초 전', this.canvasWidth/2, this.canvasHeight/2);
        }
