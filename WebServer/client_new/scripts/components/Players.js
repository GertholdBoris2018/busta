        ...
        render: function() {
            ...
            if(game.gameState === 'IN_PROGRESS' || game.gameState === 'STARTING') {
                ...
                for (i=0, length = usersWonCashed.length; i < length; i++) {
                    ...
                    trUsersWonCashed.push( D.tr({ className: classes, key: 'user' + i },
                        ...
                        D.td(null, Clib.formatSatoshis(user.bet, 0),'원'),
                        D.td({ className: bonusClass }, bonus),
                        //D.td(null, Clib.formatSatoshis(profit))
						D.td(null, Clib.formatDecimals(profit / 100, 0),'원')
                    ));
                }
                ...
                trUsersLostPlaying = usersLostPlaying.map(function(entry, i) {
                    ...
                    if (bonus) {
                        ...
                        profit = Clib.formatDecimals(profit / 100, 0);
            ...
            return D.div({ id: 'players-container' },
                ...
                D.table({ className: 'users-playing' },
                    D.thead(null,
                        D.tr(null,
                            D.th(null, D.div({ className: 'th-inner' }, '사용자')),
                            D.th(null, D.div({ className: 'th-inner' }, '배당률')),
                            D.th(null, D.div({ className: 'th-inner' }, '배팅액')),
                            D.th(null, D.div({ className: 'th-inner' }, '보너스')),
                            D.th(null, D.div({ className: 'th-inner' }, '순익'))
                        )
                    ),
                    tBody
                )
