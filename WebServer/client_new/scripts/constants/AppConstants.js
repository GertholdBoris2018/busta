...
HOST: window.document.location.host.replace(/$/, ':3842'),
            CHAT_HOST: window.document.location.host,
            //배팅금액 최대 50만원으로 설정
            MAX_BET: 50000000 /** Max bet per game 1,000,000 Bits, this will be calculated dynamically in the future, based on the invested amount in the casino **/
        },
