define([
   'socketio',
    ...
    function Chat() {
        ...
        self.chatstate = 'DECLINED'; //CONFIRMED || DECLINED
        ...
        self.ws.on('connect', function() {
            ...
            var elem_chat_confirmed = document.getElementById('currentUserChatConfirmed');
            var currentUserChatConfirmed = elem_chat_confirmed.value;
            if(currentUserChatConfirmed == "1") self.chatstate = "CONFIRMED";
        ...
        var elem_user = document.getElementById('currentUserId');
        var user_id = elem_user.value;
        self.ws.on('news_chat_approve'+user_id, function(data){
            self.chatstate = 'CONFIRMED';
        });

        self.ws.on('news_chat_decline'+user_id, function(data){
            self.chatstate = 'DECLINED';
        });
    }
