        ...
        render: function() {
            return D.div({ className: 'auto-bet-container' },
                D.div({ className: 'stra-base-bet' },
                    D.span({ className: 'bet-title' }, '기본배팅액: '),
                ...
                D.div({ className: 'stra-cash-out-at' },
                    D.span({ className: 'bet-title' }, '자동출금:'),
